# Sometimes,
#   I want to quickly be able to convert miles per imperial gallon
# into kilometers per liter.
#
# Create:
#   An application that will display the number of kilometers per liter (output)
...
def converter(mpg)
  ((mpg_km_litre = ( 1.609344 / 4.54609188 )*mpg)).round(2)
end
