...
# A player begins with a score of 0 in class E5.
# A1 is the highest level a player can achieve.
#
# Now let's say the players wants to rank up to class E4.
# To do so:
#   The player needs to achieve at least 100 points to enter the qualifying stage.
#
# Goal:
# Write a script that will check to see if the player
#   has achieved at least 100 points in his class.
