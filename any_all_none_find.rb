# The any? method returns true if the block ever returns a value
# other than false or nil for any element passed to it:
#
...
def func_find(hash)
  ...
  hash.find {
    |key, value| (key.is_a?(Integer) && (value.is_a?(Integer))) && value < 20 ||
