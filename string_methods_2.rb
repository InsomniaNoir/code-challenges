...
# Returns a new string with all the occurrences of the pattern substituted
#   for the second argument: . The pattern is typically a Regexp,
#   but a string can also be used.
#
#     "hello".gsub(/[aeiou]/, '*')                  #=> "h*ll*"
#     "hello".gsub(/([aeiou])/, '')             #=> "hll"
#
# Either method will depend upon the problem you are trying to solve,
#   and the nature of input-output behavior you desire.
#
...
#   It then replaces all the instances of words in the text
#   with the modified version.
#
#  2) A helper method strike:
#  given one string, appends strike off HTML tags around it.
